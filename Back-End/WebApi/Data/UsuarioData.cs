...
namespace WebApi.Data
{
    ...
    {
        public static bool NewOwner(Owner oUsuario)
        {
            using (SqlConnection oConexion = new SqlConnection(Conexion.rutaConexion))
            {
                ...
                cmd.Parameters.AddWithValue("@Address", oUsuario.Address);
                cmd.Parameters.AddWithValue("@Photo", oUsuario.Photo);
                cmd.Parameters.AddWithValue("@Birthday", oUsuario.Birthday);
        ...
        public static bool Modificar(OwneroUsuario)
        {
            using (SqlConnection oConexion = new SqlConnection(Conexion.rutaConexion))
            {
